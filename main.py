...
html_temp = """
        ...
        <h1 style = "color:white;text-align:center;font-size:20px;">Advance Health Care </h1>
        </div>
        """
...
with A:
    ...
    with B:
       ...
       # st_lottie(lottie_coding, height=100, key="care")
        ...
        st.image(image_lottie_animation, output_format="auto", width=100)
...
with st.sidebar:
    ...
    'Parkinsons Prediction|帕金森病检测','联系我们'],
                  icons=['bank', 'book-half', 'activity', 'heart', 'person-plus-fill', 'send-check-fill'])
...
if bio == "联系我们":
        ...
        st.markdown('<p class="font">Get In Touch with Advance Health Care Team:</p>', unsafe_allow_html=True)
        contact_form = """
