...
html_temp = """
        ...
        <h1 style = "color:white;text-align:center;font-size:15px;">检测并聊 </h1>
        </div>
        """
...
with A:
    ...
    with B:
        ...
        st_lottie(lottie_coding, height=80, key="care")

bio = option_menu(menu_title="检测并聊", options=
['主页', 'Education|教育', 'Diabetes Prediction|糖尿病检测',
 'Heart Disease Prediction|心脏病检测',
 'Parkinsons Prediction|帕金森病检测', 'About me|关于我', '联系我们'],
                  icons=['bank', 'book-half', 'activity', 'heart', 'person-plus-fill', 'person-circle',
                         'send-check-fill', ],default_index=0,
...
if bio == "About me|关于我":
    st.write("---")
    st.write("My Name is Takudzwa Choto")
    st.write("""

     - I am a computer science student at Zunyi School Of International Education.
...
if bio == "Education|教育":
    ...
    st_lottie(lottie_coding, height=80, key="diabetes")
    st.write("""
    ...
    st_lottie(lottie_coding, height=80, key="parkinson")
    st.write("""
    ...
    st_lottie(lottie_coding, height=80, key="heart")
    st.write("""
...
if bio == "主页":
    ...
    st.write(
        "在这里，它向个人展示了如何根据医生提供的关于心脏糖尿病、帕金森病和心脏病两个阶段的信息来测试自己的算法。")
